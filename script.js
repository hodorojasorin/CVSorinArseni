...
const translations = {
  ro: {
    ...
    'contact': 'Contact',
    'bibl': 'bibl.ceiti.md',
    'about.subtitle': 'Digital Creator',
    'about.p1': 'Salut! Sunt Sorin, digital creator. Aici găsești proiectele IT pe care le-am realizat de-a lungul timpului — printre ele și acest site, un portofoliu static construit fără niciun framework.',
    'skills': 'Competențe',
    'projects.hint': '2 proiecte · mai multe în curând…',
    'main': 'sorinarseni.com',
    'main.subtitle': 'Site-ul meu principal',
    'main.p1': 'Cartea mea de vizită online — cine sunt, ce fac și unde mă găsești, într-un design creativ în stil scris de mână. Disponibil în mai multe limbi.',
    'main.visit': 'Vizitează sorinarseni.com',
    'bibl.title': 'Biblioteca CEITI',
    'bibl.subtitle': 'Primul meu proiect web',
    'bibl.p1': 'Platformă web care digitalizează complet biblioteca Centrului de Excelență în Informatică și Tehnologii Informaționale (CEITI): catalog digital cu căutare și filtrare, rezervări online, panou de administrare pentru bibliotecar, chioșc self-service cu autentificare prin PIN sau cod QR și rapoarte PDF printabile. Primul proiect real la care am lucrat.',
    'tech': 'Tehnologii',
  ...
  en: {
    ...
    'bibl': 'bibl.ceiti.md',
    'about.subtitle': 'Digital Creator',
    'about.p1': "Hi! I'm Sorin, a digital creator. Here you'll find the IT projects I've built over time — including this site itself, a static portfolio built without any framework.",
    'skills': 'Skills',
    'projects.hint': '2 projects · more coming soon…',
    'main': 'sorinarseni.com',
    'main.subtitle': 'My main website',
    'main.p1': 'My online business card — who I am, what I do and where to find me, in a creative handwritten-style design. Available in multiple languages.',
    'main.visit': 'Visit sorinarseni.com',
    'bibl.title': 'CEITI Library',
    'bibl.subtitle': 'My first web project',
    'bibl.p1': 'A web platform that fully digitalizes the library of the Center of Excellence in Informatics and Information Technologies (CEITI): digital catalog with search and filtering, online reservations, an admin panel for the librarian, a self-service kiosk with PIN or QR code login, and printable PDF reports. The first real project I worked on.',
    'tech': 'Technologies',
  ...
  it: {
    ...
    'bibl': 'bibl.ceiti.md',
    'about.subtitle': 'Digital Creator',
    'about.p1': 'Ciao! Sono Sorin, digital creator. Qui trovi i progetti IT che ho realizzato nel tempo — incluso questo sito, un portfolio statico costruito senza alcun framework.',
    'skills': 'Competenze',
    'projects.hint': '2 progetti · altri in arrivo…',
    'main': 'sorinarseni.com',
    'main.subtitle': 'Il mio sito principale',
    'main.p1': 'Il mio biglietto da visita online — chi sono, cosa faccio e dove trovarmi, con un design creativo in stile scritto a mano. Disponibile in più lingue.',
    'main.visit': 'Visita sorinarseni.com',
    'bibl.title': 'Biblioteca CEITI',
    'bibl.subtitle': 'Il mio primo progetto web',
    'bibl.p1': "Una piattaforma web che digitalizza completamente la biblioteca del Centro di Eccellenza in Informatica e Tecnologie dell'Informazione (CEITI): catalogo digitale con ricerca e filtri, prenotazioni online, pannello di amministrazione per il bibliotecario, chiosco self-service con accesso tramite PIN o codice QR e report PDF stampabili. Il primo progetto reale a cui ho lavorato.",
    'tech': 'Tecnologie',
